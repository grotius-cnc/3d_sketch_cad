...
bool DRW_Arc::parseCode(int code, const std::unique_ptr<dxfReader>& reader){
    ...
    //! 3d Arc waypoint.
    case 12:
        arcwayPoint.x = reader->getDouble();
        break;
    case 22:
        arcwayPoint.y = reader->getDouble();
        break;
    case 32:
        arcwayPoint.z = reader->getDouble();
        break;
    //! 3d Arc endpoint.
    case 13:
...
bool DRW_Arc::parseDwg(DRW::Version version, dwgBuffer *buf, duint32 bs){
    ...
    arcwayPoint.x = buf->getBitDouble();
    arcwayPoint.y = buf->getBitDouble();
    arcwayPoint.z = buf->getBitDouble();
    DRW_DBG("arc way point: "); DRW_DBGPT(arcwayPoint.x, arcwayPoint.y, arcwayPoint.z);
        ...
        if (!(loop->type & 2)){ //Not polyline
            ...
            for (dint32 j = 0; j<numPathSeg;++j){
                ...
                if (typePath == 1){ //line
                    ...
                    arc->arcwayPoint = buf->get2RawDouble();
