...
bool dxfRW::writeArc(DRW_Arc *ent) {
    ...
    writer->writeDouble(11, ent->arcstartPoint.x);
    writer->writeDouble(21, ent->arcstartPoint.y);
    writer->writeDouble(31, ent->arcstartPoint.z);

    writer->writeDouble(12, ent->arcwayPoint.x);
    writer->writeDouble(22, ent->arcwayPoint.y);
    writer->writeDouble(32, ent->arcwayPoint.z);

    writer->writeDouble(13, ent->arcendPoint.x);
    writer->writeDouble(23, ent->arcendPoint.y);
    writer->writeDouble(33, ent->arcendPoint.z);
    return true;
}
            ...
            if ( (loop->type & 2) == 2){
                ...
                for (int j = 0; j<loop->numedges; ++j) {
                    ...
                    case DRW::ARC: {
                        ...
                        writer->writeDouble(11, a->arcstartPoint.x);
                        writer->writeDouble(21, a->arcstartPoint.y);
                        writer->writeDouble(31, a->arcstartPoint.z);
                        writer->writeDouble(12, a->arcwayPoint.x);
                        writer->writeDouble(22, a->arcwayPoint.y);
                        writer->writeDouble(32, a->arcwayPoint.z);
                        writer->writeDouble(13, a->arcendPoint.x);
                        writer->writeDouble(23, a->arcendPoint.y);
                        writer->writeDouble(33, a->arcendPoint.z);
                        break; }
                    case DRW::ELLIPSE: {
