...
public:
    ...
    const DRW_Coord & arc_startpoint() { return arcstartPoint; }
    const DRW_Coord & arc_waypoint() { return arcwayPoint; }
    const DRW_Coord & arc_endpoint() { return arcendPoint; }
...
public:
    ...
    DRW_Coord arcstartPoint;    /*!< third point, code 11, 21 & 31 */
    DRW_Coord arcwayPoint;      /*!< third point, code 12, 22 & 32 */
    DRW_Coord arcendPoint;      /*!< four point, code 13, 23 & 33 */
};
