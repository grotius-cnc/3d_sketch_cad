  ...
  myPrevCameraFocalPlaneDist(0.f)
{
  ...
  std::cout<<"OpenGL_View 0"<<std::endl;
}
...
{
  std::cout<<"OpenGL_View standard transient 691"<<std::endl;
...
{
    std::cout<<"OpenGL_View standard transient fbo create"<<std::endl;
...
void OpenGl_View::FBORelease (Handle(Standard_Transient)& theFbo)
{
 ...
 std::cout<<"OpenGL_View standard transient fbo release"<<std::endl;
