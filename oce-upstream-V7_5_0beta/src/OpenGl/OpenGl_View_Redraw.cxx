...
void OpenGl_View::Redraw()
{
    ...
    /*
    aCtx->SetLineFeather(1);
    aCtx->SetLineWidth(2);
    aCtx->SetWindowSRGB(1);
    aCtx->core11->glBegin(GL_LINE_LOOP);
    aCtx->core11->glColor3b(1,1,0);
    aCtx->core11->glVertex3d(0, 0, 0);
    aCtx->core11->glVertex3d(0, 50, 0);
    aCtx->core11->glVertex3d(50, 50, 0);
    aCtx->core11->glVertex3d(50, 0, 0);
    aCtx->core11->glVertex3d(0, 0, 0);
    aCtx->core11->glEnd();*/
...
void OpenGl_View::renderStructs (Graphic3d_Camera::Projection theProjection,
                                 ...
                                 const Standard_Boolean       theToDrawImmediate)
{
    // std::cout<<"renderStructs"<<std::endl;
    ...
    /*
    aCtx->core11->glBegin(GL_LINE_LOOP);
    aCtx->core11->glColor3b(1,0,0);
    aCtx->core11->glVertex3d(0, 0, 0);
    aCtx->core11->glVertex3d(0, 0.5, 0);
    aCtx->core11->glVertex3d(0.5, 0.5, 0);
    aCtx->core11->glVertex3d(0.5, 0, 0);
    aCtx->core11->glVertex3d(0, 0, 0);
    aCtx->core11->glEnd();*/
                               ...
                               const Standard_Boolean theToFlip)
{
    ...
    // std::cout<<"OpenGL_view blitbuffer"<<std::endl;
    Handle(OpenGl_Context) aCtx = myWorkspace->GetGlContext();
/*
    aCtx->core11->glBegin(GL_LINE_LOOP);
    aCtx->core11->glColor3b(1,0,0);
    aCtx->core11->glVertex3d(0, 0, 0);
    aCtx->core11->glVertex3d(0, 0.2, 0);
    aCtx->core11->glVertex3d(0.2, 0.2, 0);
    aCtx->core11->glVertex3d(0.2, 0, 0);
    aCtx->core11->glVertex3d(0, 0, 0);
    aCtx->core11->glEnd();*/
